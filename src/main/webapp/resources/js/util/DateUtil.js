var DateUtil = {
    ...
    getWeekStartDate : function(date){
        return this.dateAdd("d", date.getDay() * -1 + 1,  date);
    },
    
    getWeekEndDate : function(date){
        return this.dateAdd("d", 7 - date.getDay(), date);
    },
    
    getMonthStartDate : function(date) {
        return this.dateAdd("d", date.getDate() * -1 + 1,  date);
    },
    
    getMonthEndDate : function(date) {
        var temp1 = this.dateAdd("m", 1, date);
        temp1.setDate(1);
        return this.dateAdd("d", -1, temp1);
    },
    
    /**
     * 获取的开始/结束日期
     */  
    getStartAndEndDate_byDateType : function(date, dateType) {
        var ret = {
            startDate : undefined,
            endDate : undefined
        };
        ...
        if (dateType === "w") {
            ret.startDate = this.getWeekStartDate(date);
            ret.endDate = this.getWeekEndDate(date);
        } else if (dateType === "m") {
            ret.startDate = this.getMonthStartDate(date);
            ret.endDate = this.getMonthEndDate(date);
        } else if (dateType === "d") {
            ret.startDate = date;
            ret.endDate = date;
        }
    ...
    getNow_yyyyMMdd : function() {
        return this.dateToStr_yyyyMMdd(new Date);
    },
